...
CREATE TABLE IF NOT EXISTS games(
  ...
  orders_time TIME WITH TIME ZONE,
  orders_span INTEGER,
  retreats_day VARCHAR(9),
  retreats_time TIME WITH TIME ZONE,
  retreats_span INTEGER,
  adjustments_day VARCHAR(9),
  adjustments_time TIME WITH TIME ZONE,
  adjustments_span INTEGER,
  nominations_day VARCHAR(9),
  nominations_time TIME WITH TIME ZONE,
  nominations_span INTEGER,
  votes_day VARCHAR(9),
  votes_time TIME WITH TIME ZONE,
  votes_span INTEGER,
