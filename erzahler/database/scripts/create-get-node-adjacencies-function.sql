    ...
    json_agg(CASE
      WHEN n.node_id = na.node_1_id
        THEN json_build_object(
          'node_id', na.node_2_id, 'province_id', p2.province_id, 'province_name', p2.province_name
        )
      WHEN n.node_id = na.node_2_id
        THEN json_build_object(
          'node_id', na.node_1_id, 'province_id', p1.province_id, 'province_name', p1.province_name
        )
    END) AS adjacencies
  FROM nodes n
